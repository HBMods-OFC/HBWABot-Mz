...
exports.tanggal = (numer) => {
	myMonths = ["January","February","March","April","May","June","July","August","September","October","November","Desember"];
				myDays = ['Chawlhni','Thawhṭanni','Thawhlehni','Nilaini','Ningani','Zirtawpni','Inrinni']; 
